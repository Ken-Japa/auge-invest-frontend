...
export const fetchETFBySlugOrCode = async (param: string, isCode: boolean): Promise<ETF | null> => {
  try {
    ...
    console.error(`Error fetching ETF with param ${param} (isCode: ${isCode}):`, error)
    throw error
  }
}
