...
export const TabelaView: React.FC<TabelaViewProps> = ({ onLoadingChange }) => {
  ...
  const sortedIndustrias = [...data.sumario].sort((a, b) => b.valorMercadoTotal - a.valorMercadoTotal)
    ...
    <TableContainer>
      <TableControlsContainer>
        <CheckboxesContainer>
          <FormControlLabel
            control={
              <Checkbox checked={hideIndustrias} onChange={(e) => setHideIndustrias(e.target.checked)} />
            }
            label="Ocultar Indústrias"
          />
          <FormControlLabel
            control={
              <Checkbox checked={hideSegmentos} onChange={(e) => setHideSegmentos(e.target.checked)} />
            }
      ...
      {hideIndustrias && hideSegmentos ? (
        <FlatTableView data={data} orderBy={orderBy} order={order} handleSort={handleSort} />
      ) : hideIndustrias ? (
