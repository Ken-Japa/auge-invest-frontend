...
export const generateOperationalMetrics = (fundamentalData: DadosAnaliseFundamental): string => {
  ...
  const operationalMetrics: MetricItem[] = [
    {
      ...
      value: fundamentalData.receitaLiquida ? fundamentalData.receitaLiquida * 1000 : undefined,
      isCurrency: true,
    },
    {
      name: 'EBITDA',
    ...
    {
      name: 'Lucro Líquido',
      value: fundamentalData.lucroLiquido ? fundamentalData.lucroLiquido * 1000 : undefined,
      isCurrency: true,
    },
    {
      name: 'Patrimônio Líquido',
      value: fundamentalData.patrimonioLiquido ? fundamentalData.patrimonioLiquido * 1000 : undefined,
      isCurrency: true,
    },
    {
      name: 'Caixa e Equivalentes',
      value: fundamentalData.caixaEquivalentes ? fundamentalData.caixaEquivalentes * 1000 : undefined,
      isCurrency: true,
    },
