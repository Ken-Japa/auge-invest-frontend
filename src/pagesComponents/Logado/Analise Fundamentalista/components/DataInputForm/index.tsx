...
const ALLOW_NEGATIVE_FIELDS = ['ebit', 'ebitda', 'lucroLiquido', 'dividaLiquida', 'impostoRenda']
...
const FIELD_WARNINGS = {
  ...
  impostoRenda:
    'Valor negativo indica créditos fiscais. O ROIC ajustará o lucro operacional para refletir esse benefício.',
}
