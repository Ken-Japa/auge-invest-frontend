...
interface ScenariosSectionProps {
  ...
  onScenarioChange: (scenario: 'otimista' | 'pessimista', field: keyof ScenarioInput, value: number) => void
}
...
export const ScenariosSection: FC<ScenariosSectionProps> = ({
  ...
  const handleSliderChange =
    (scenario: 'otimista' | 'pessimista', field: keyof ScenarioInput) =>
    ...
    <SensitivityContainer>
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Box sx={{ px: 2, py: 1 }}>
            <Typography gutterBottom>WACC: {scenarioInputs.pessimista.wacc}%</Typography>
            <Slider
        ...
        <Grid item xs={12} md={6}>
          ...
          <Box sx={{ px: 2, py: 1 }}>
            <Typography gutterBottom>WACC: {scenarioInputs.otimista.wacc}%</Typography>
            <Slider
        ...
        {sensitivityResults && (
          <Grid item xs={12}>
            ...
            <Box sx={{ mt: 2 }}>
              <Typography>
                Variação de Preço: R$ {sensitivityResults.pessimista.precoJusto.toFixed(2)} - R${' '}
                {sensitivityResults.otimista.precoJusto.toFixed(2)}
              </Typography>
            </Box>
          </Grid>
        )}
