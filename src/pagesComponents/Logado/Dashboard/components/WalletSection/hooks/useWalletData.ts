...
export const useWalletData = () => {
    ...
    const handleCreateWallet = useCallback(async (name: string, description: string) => {
        if (!userId || !name) {
    ...
    const handleUpdateWallet = useCallback(async (walletId: string, name: string, description: string) => {
        if (!walletId || !name) {
    ...
    const handleConfirmDelete = useCallback(async (walletToDelete: string) => {
