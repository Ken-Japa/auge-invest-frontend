      ...
      <IndicesContainer>
        <TabsContainer>
          ...
          >
              ...
              <CustomTab
                ...
                label={
                  <TabActions>
                    {tab.name}
                    {tabs.length > 1 && (
                      <StyledIconButton size="small" onClick={(e) => handleCloseTab(tab.id, e)}>
            ...
            <AddTabButton icon={<AddIcon />} onClick={() => setIsSearchOpen(true)} />
          </Tabs>
        ...
        <SearchDialog open={isSearchOpen} onClose={() => setIsSearchOpen(false)} onSelect={handleAddTab} />
      </IndicesContainer>
    </SuspenseWrapper>
  )
}
