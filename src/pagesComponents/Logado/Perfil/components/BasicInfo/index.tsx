...
import { ThemePreference } from '@/theme/components/TrocarTema'

const EditDialog = lazy(() => import('../EditDialog').then((mod) => ({ default: mod.EditDialog })))
const PasswordDialog = lazy(() =>
  import('../PasswordDialog').then((mod) => ({ default: mod.PasswordDialog })),
)
import {
  EditButton,
  InfoContainer,
