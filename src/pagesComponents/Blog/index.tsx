...
const BlogCategories = lazy(() =>
  import('./components/BlogCategories').then((mod) => ({ default: mod.BlogCategories })),
)
const BlogCardList = lazy(() =>
  import('./components/BlogCardList').then((mod) => ({ default: mod.BlogCardList })),
)
...
const Blog: FC<BlogProps> = ({ posts }) => {
  ...
  const IMAGE_PROPS = {
    src: '/assets/images/background/Blog.webp',
