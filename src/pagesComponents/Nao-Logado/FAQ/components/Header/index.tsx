  ...
  return (
    <HeaderContainer>
      <div className="header-icon-wrapper">
        <HeaderIcon />
        <DynamicMatrixRainText text="Dúvidas Frequentes" className="title" />
      </div>
      <p className="subtitle">Encontre respostas para as perguntas mais comuns sobre a Auge Invest</p>
    </HeaderContainer>
  )
}
