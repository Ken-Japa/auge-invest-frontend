  ...
  const imageProps = {
    src:
      theme.palette.mode === 'dark'
        ? '/assets/images/background/Desenvolvimento-Dark.webp'
        : '/assets/images/background/Desenvolvimento-Light.webp',
        ...
        <SuspenseWrapper fallback={<ContentSkeleton type="card" height={800} />}>
          <ProgressiveLoad threshold={0.1} delay={0.2}>
            <PageContainer>
              ...
              <Page>
                <SectionTitle variant="h2">Ferramentas em Desenvolvimento</SectionTitle>
                <Typography variant="h3" align="center" color="text.secondary" sx={{ mb: 4 }}>
                  Estamos constantemente trabalhando para trazer as melhores ferramentas para você. Confira
                  abaixo o que está por vir!
                </Typography>
