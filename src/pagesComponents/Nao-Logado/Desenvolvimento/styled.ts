...
export const PageContainer = styled(Box)(({ theme }) => ({
  ...
  '&::before': {
    ...
    width: '100%',
    height: '100%',
    backgroundColor: theme.palette.mode === 'dark' ? 'rgba(18, 24, 38, 0.4)' : 'rgba(255, 255, 255, 0.7)',
  },
}))
...
export const Page = styled(Container)(({ theme }) => ({
  ...
  backgroundColor: theme.palette.mode === 'dark' ? 'rgba(24, 33, 57, 1)' : 'rgba(255, 255, 255, 0.85)',
}))
