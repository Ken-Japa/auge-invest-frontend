...
export const Card: FC<CardProps> = ({
  ...
  return (
    <CardContainer className="glow-hover gradient-bg" direction="column" alignItems="center" padding="30px">
      <h3 className="text-2xl mb-4 glitch text-white" data-text={title}>
        {title}
      </h3>
