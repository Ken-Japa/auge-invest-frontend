      ...
      <div className="home">
        <div className="welcome mb-20">
          <div className="title-left">
            <DynamicMatrixRainText text="Seja bem vindo a" className="text-white" />
          </div>
          <div className="title-right">
            <DynamicMatrixRainText text="Auge Invest" className="text-white font-bold text-5xl" />
          </div>
        </div>
              ...
              <Grid item xs={12} md={6}>
                <Stack spacing={4}>
                  ...
                  <Typography variant="body1" className="text-white/90">
                    A única plataforma do Brasil com{' '}
                    <span className="text-[#FF6B00] font-bold">histórico de derivativos</span>, simulação de
                    estratégias em cenários reais e fictícios e recomendações através de análises – para você
