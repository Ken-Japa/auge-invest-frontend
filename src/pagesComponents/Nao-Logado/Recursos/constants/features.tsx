...
export const FEATURES = [
  {
    ...
    description:
      'Ferramentas poderosas de análise técnica e fundamentalista para tomada de decisões mais precisas.',
    details: [
      'Indicadores técnicos personalizáveis',
  ...
  },
  {
    ...
    description:
      'Receba notificações instantâneas sobre movimentações importantes do mercado e oportunidades de investimento.',
  ...
  },
  {
    ...
    details: [
      'Dashboard com visão geral da economia',
      'Histograma definindo oportunidades',
      'Plataforma disponível para celulares',
    ],
  },
  {
