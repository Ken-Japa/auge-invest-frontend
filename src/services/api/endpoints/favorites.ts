...
import { CreateFavorite, Favorite, FavoriteFilter, FavoriteListResponseApi } from '../types/favorite'
import { getPaginationParams } from '../utils/pagination'

class FavoritesApiService extends BaseApiService {
  getFavoritesByUser = async (filters?: FavoriteFilter): Promise<FavoriteListResponseApi> => {
    ...
    try {
      return await this.get<FavoriteListResponseApi>(`${API_ENDPOINTS.FAVORITES.BASE}/user`, params)
    } catch (error) {
