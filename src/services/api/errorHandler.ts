...
const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [ErrorCode.USER_NOT_FOUND]: 'Usuário não encontrado. Por favor, verifique as informações fornecidas.',
  [ErrorCode.INVALID_CREDENTIALS]: 'Email ou senha inválidos. Por favor, tente novamente.',
  [ErrorCode.SERVER_ERROR]: 'Erro no servidor. Por favor, tente novamente mais tarde.',
  [ErrorCode.NETWORK_ERROR]: 'Erro de rede. Por favor, verifique sua conexão com a internet.',
  [ErrorCode.UNKNOWN_ERROR]: 'Ocorreu um erro inesperado. Por favor, tente novamente.',
  [ErrorCode.COMPANY_NOT_FOUND]: 'Empresa não encontrada. Por favor, verifique as informações fornecidas.',
  [ErrorCode.COMPANY_DATA_ERROR]: 'Erro ao processar dados da empresa. Por favor, tente novamente.',
  [ErrorCode.REGISTRATION_FAILED]:
    'Falha no registro. Por favor, verifique as informações e tente novamente.',
  [ErrorCode.FII_NOT_FOUND]: 'FII não encontrado. Por favor, verifique as informações fornecidas.',
  [ErrorCode.FII_DATA_ERROR]: 'Erro ao processar dados do FII. Por favor, tente novamente.',
  [ErrorCode.BDR_NOT_FOUND]: 'BDR não encontrado. Por favor, verifique as informações fornecidas.',
  [ErrorCode.BDR_DATA_ERROR]: 'Erro ao processar dados do BDR. Por favor, tente novamente.',
  [ErrorCode.ETF_NOT_FOUND]: 'ETF não encontrado. Por favor, verifique as informações fornecidas.',
  ...
  [ErrorCode.TRANSACTION_NOT_FOUND]:
    'Transação não encontrada. Por favor, verifique as informações fornecidas.',
